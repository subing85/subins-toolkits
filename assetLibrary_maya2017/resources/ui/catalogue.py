...
from assetLibrary_maya2017.core import assets
...
class Catalogue(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.listwidget_catalogue.keyReleaseEvent = (
    ...
    def search_assets(self, input_widget):
        ...
        self.load_assets(
            self.treewidget_search, search_obj.get_assets, groups
        )
    ...
    def load_assets(self, treeWidget, paths, groups):
        ...
        for index in range(len(paths)):
            ...
            combobox = QtWidgets.QComboBox(treeWidget)
