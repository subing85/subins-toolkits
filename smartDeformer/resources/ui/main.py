...
class MainWindow(QtGui.QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.verticallayout_convert = QtGui.QVBoxLayout(
            self.page_convert
        )
        ...
        self.verticallayout_cluster = QtGui.QVBoxLayout(
            self.page_cluster
        )
        ...
        self.verticallayout_weights = QtGui.QVBoxLayout(
            self.page_weights
        )
        ...
        self.verticallayout_credit = QtGui.QVBoxLayout(
            self.page_credit
        )
