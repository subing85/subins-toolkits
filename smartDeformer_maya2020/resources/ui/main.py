...
from smartDeformer_maya2020.resources.ui import geometry
from smartDeformer_maya2020.resources.ui import mirror
from smartDeformer_maya2020.resources.ui import weights
from smartDeformer_maya2020.utils import platforms
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.verticallayout_convert.setObjectName(
            "verticallayout_convert"
        )
        ...
        self.horizontallayout_convert.setObjectName(
            "horizontallayout_convert"
        )
        self.verticallayout_convert.addLayout(
            self.horizontallayout_convert
        )
        ...
        self.verticallayout_cluster = QtWidgets.QVBoxLayout(
            self.page_cluster
        )
        self.verticallayout_cluster.setObjectName(
            "verticalLayout_cluster"
        )
        ...
        self.verticallayout_weights = QtWidgets.QVBoxLayout(
            self.page_weights
        )
        self.verticallayout_weights.setObjectName(
            "verticalLayout_weights"
        )
        ...
        self.verticallayout_credit = QtWidgets.QVBoxLayout(
            self.page_credit
        )
        self.verticallayout_credit.setObjectName(
            "verticallayout_credit"
        )
        ...
        log_path = os.path.join(
            resources.getIconPath(), "smart_deformer.png"
        )
        icon = QtGui.QIcon()
        icon.addPixmap(
        ...
        self.button_help.setText(
            "About Smart Deformer 0.0.1 (Help)\n"
        )
