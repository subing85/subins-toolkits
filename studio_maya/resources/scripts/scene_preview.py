        ...
        "sun": {
            ...
            "position": {
                ...
                2: {
                    ...
                    "translate": [0.0, 34.2, -93.97],
                },
                3: {
                    "rotate": [-140.0, -0.0, 0.0],
                    "translate": [0.0, 64.28, -76.6],
                },
                4: {
                    "rotate": [-120.0, -0.0, 0.0],
                    "translate": [0.0, 86.6, -50.0],
                },
                5: {
                    "rotate": [-100.0, -0.0, 0.0],
                    "translate": [0.0, 98.48, -17.36],
                },
                6: {
                    "rotate": [-80.0, -0.0, 0.0],
                    "translate": [0.0, 98.48, 17.36],
                ...
                10: {
                    ...
                    "translate": [34.2, -0.0, 93.97],
                },
                11: {
                    "rotate": [40.0, -0.0, 90.0],
                    "translate": [64.28, -0.0, 76.6],
                },
                12: {
                    "rotate": [60.0, -0.0, 90.0],
                    "translate": [86.6, -0.0, 50.0],
                },
                13: {
                    "rotate": [80.0, -0.0, 90.0],
                    "translate": [98.48, -0.0, 17.36],
                },
                14: {
                    "rotate": [100.0, -0.0, 90.0],
                    "translate": [98.48, -0.0, -17.36],
                },
                15: {
                    "rotate": [120.0, -0.0, 90.0],
                    "translate": [86.6, -0.0, -50.0],
                },
                16: {
                    "rotate": [140.0, -0.0, 90.0],
                    "translate": [64.28, -0.0, -76.6],
                },
                17: {
                    "rotate": [160.0, -0.0, 90.0],
                    "translate": [34.2, -0.0, -93.97],
                },
                18: {
                    "rotate": [-160.0, -0.0, 90.0],
                ...
                28: {
                    ...
                    "translate": [-93.97, 34.2, 0.0],
                },
                29: {
                    "rotate": [-140.0, 90.0, 0.0],
                    "translate": [-76.6, 64.28, -0.0],
                },
                30: {
                    "rotate": [-120.0, 90.0, 0.0],
                    "translate": [-50.0, 86.6, -0.0],
                },
                31: {
                    "rotate": [-100.0, 90.0, 0.0],
                    "translate": [-17.36, 98.48, -0.0],
                },
                32: {
                    "rotate": [-80.0, 90.0, 0.0],
                    "translate": [17.36, 98.48, 0.0],
                },
                33: {
                ...
                38: {
                    "rotate": [-160.0, 45.0, 0.0],
                    "translate": [-66.45, 34.2, -66.45],
                },
                39: {
                    "rotate": [-140.0, 45.0, 0.0],
                    "translate": [-54.17, 64.28, -54.17],
                },
                40: {
                    "rotate": [-120.0, 45.0, 0.0],
                    "translate": [-35.36, 86.6, -35.36],
                },
                41: {
                    "rotate": [-100.0, 45.0, 0.0],
                    "translate": [-12.28, 98.48, -12.28],
                },
                42: {
                    "rotate": [-80.0, 45.0, 0.0],
                    "translate": [12.28, 98.48, 12.28],
                },
                43: {
                ...
                44: {
                    "rotate": [-40.0, 45.0, 0.0],
                    "translate": [54.17, 64.28, 54.17],
                },
                45: {
                    "rotate": [-20.0, 45.0, 0.0],
                    "translate": [66.45, 34.2, 66.45],
                },
                46: {
                    "rotate": [0.0, -45.0, 0.0],
...
def render_layer():
    ...
    if core.objExists(layer):
        ...
        core.delete(layer)
    render_layer = core.createRenderLayer(
        geometrys, n=layer, num=1, nr=1
    )
...
def get_render_cmd():
    ...
    if operating_system == "Windows":
        return os.path.join(
            os.environ["PYTHONHOME"], "bin", "Render.exe"
        )
    ...
    for k, v in light_data.items():
        ...
        for index in v["position"]:
            ...
            light = core.directionalLight(
                rot=rotation, pos=translate, i=intensity, rgb=color
            )
...
def create(engine, render_camera, width, height, output, light):
    ...
    for render_global, contents in render_parameters.items():
        ...
        if render_global == "defaultRenderGlobals":
            ...
            if not core.objExists(
                "defaultRenderGlobals.encodingQuality"
            ):
                global_node.addAttr(
                    "encodingQuality",
                    ci=True,
...
result = create(
    RENDER_ENGINE, CAMERA, WIDTH, HEIGHT, OUTPUT_DIR, LIGHT_SETUP
)
