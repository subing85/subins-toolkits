...
class TemplatePublish(QtGui.QWidget):
    def __init__(self, parent=None, **kwargs):
        ...
        :example
            ...
            window.show()
        """
        super(TemplatePublish, self).__init__(
    ...
    def setup_ui(self):
        ...
        self.combobox_type.currentIndexChanged.connect(
            partial(self.set_current_versions, None)
        )
        ...
        self.combobox_versions.currentIndexChanged.connect(
            partial(self.set_current_versions, None)
        )
        ...
        self.button_publish.clicked.connect(
    ...
    def set_current_versions(self, *args):
        ...
        temp_version = versions.get_latest_version(
            self.template_path, current_type
        )
        latest_version = None
        if temp_version:
    ...
    def set_publish(self, *args):
        ...
        publish_dirname = os.path.join(
            self.template_path, current_type, next_version
        )
