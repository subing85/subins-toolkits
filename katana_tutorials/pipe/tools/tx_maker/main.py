...
class TxMaker(QtGui.QWidget):
    ...
    def setup_ui(self):
        ...
        self.button_txmake.clicked.connect(
            partial(
                self.set_dirname, self.lineedit_txmake, mode=False
            )
        )
        ...
        self.lineedit_source.textChanged.connect(
        ...
        self.button_out.clicked.connect(
            partial(self.set_dirname, self.lineedit_out, mode=True)
        )
