...
class TextureManager(QtGui.QWidget):
    ...
    def setup_ui(self):
        ...
        self.button_node.clicked.connect(
            partial(
                self.load_node, self.lineedit_node, self.treewidget
            )
        )
    ...
    def load_node(self, widget, treewidget):
        ...
        valid, materials, message = texture.find_materials(
            current_node
        )
        if not valid:
    ...
    def search_replace(
        self, search_widget, replace_widget, treewidget
    ):
        ...
        for child in children:
            ...
            texture.search_and_replace(
                texture_node, texture_path, search_for, replace_with
            )
