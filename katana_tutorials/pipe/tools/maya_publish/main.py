...
class MayaPublish(QtWidgets.QWidget):
    def __init__(self, parent=None, **kwargs):
        ...
        :example
            ...
            window.show()
        """
        super(MayaPublish, self).__init__(
    ...
    def setup_ui(self):
        ...
        self.combobox_pipe.currentIndexChanged.connect(
        ...
        self.lineedit_sequence.textEdited.connect(
            self.set_name_change
        )
        ...
        self.button_asset.clicked.connect(
            partial(self.set_publish, None)
        )
    ...
    def set_puppet_depnendency(self):
        ...
        model_depnendency = publish.get_lookdev_model_depnendency(
            category, name
        )
    ...
    def set_current_versions(self):
        ...
        next_version = versions.get_next_version(
            version_index, temp_version
        )
    ...
    def get_publish_path(self):
        ...
        if pipe == "asset":
            publish_path = os.path.join(
                show_path, "asset", inputs["category"], inputs["name"]
            )
        ...
        if pipe == "scene":
            ...
            publish_path = os.path.join(
                show_path, "scene", inputs["sequence"], inputs["shot"]
            )
