...
class Menu(object):
    def __init__(self, title):
        ...
        self.main_layout = self.get_mainlayout(
    ...
    def setup_ui(self):
        ...
        self.horizontallayout_console.setObjectName(
            "horizontallayout_console"
        )
        ...
        self.set_icon(
            self.button_clear,
            os.path.join(self.icon_path, "clear.png"),
        )
        ...
        self.horizontallayout_console.addWidget(
            self.lindeedit_console
        )
    ...
    def set_studio_console(self, bypass=True):
        ...
        studio_console.stdout().message_written.connect(
            self.show_console
        )
    ...
    def get_shelf_items(self):
        ...
        for shelf in shelfs:
            ...
            pipe_shelf = Shelves.Shelf(
                shelf, shelf_path, Shelves.SHELF_TYPE_USER
            )
    ...
    def create_from_shelf(self):
        ...
        for name, pipe_shelf in shelf_items.items():
            shelf_menu = self.add_sub_menu(
                self.studio_menu, name, "shelf"
            )
            # ===================================================================
            ...
            for item in pipe_shelf.getItems():
                ...
                action = self.add_actions(
                    shelf_menu, name, description, icon_name
                )
                action.triggered.connect(
                    partial(self.shelf_action, item)
                )
    ...
    def create_from_toolkit(self):
        ...
        for index, modules in toolkit_items.items():
            for module in modules:
                ...
                action.triggered.connect(
                    partial(self.toolkit_action, module)
                )
