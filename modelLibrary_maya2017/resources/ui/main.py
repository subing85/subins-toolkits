...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def publish(self):
        ...
        if not os.path.isdir(current_path):
            QtWidgets.QMessageBox.warning(
                self, 'Warning', 'Not found such Publish directory!...%s' % current_path, QtWidgets.QMessageBox.Ok)
        ...
        if not geometry_dag_paths.length():
            QtWidgets.QMessageBox.warning(
                self, 'Warning', 'Not found any Polygon Geometry in your selection!...', QtWidgets.QMessageBox.Ok)
            OpenMaya.MGlobal.displayWarning(
        ...
        if not label:
            QtWidgets.QMessageBox.warning(
                self, 'Warning', 'Not found the Name of the the Publish!...', QtWidgets.QMessageBox.Ok)
            OpenMaya.MGlobal.displayWarning(
        ...
        if studio_model.had_file(current_path, label):
            replay = QtWidgets.QMessageBox.warning(self, 'Warning',
        ...
        QtWidgets.QMessageBox.information(
            self, 'Information', 'Publish success!...', QtWidgets.QMessageBox.Ok)
    ...
    def builds(self, tag, listwidge, *args):
        ...
        if not current_items:
            QtWidgets.QMessageBox.warning(
                self, 'Warning', 'Not select any models or model not valid!...', QtWidgets.QMessageBox.Ok)
            OpenMaya.MGlobal.displayWarning(
