...
from modelLibrary_maya2017.modules import studioFolder
from modelLibrary_maya2017.modules import studioMaya
from modelLibrary_maya2017.modules import studioModel

from modelLibrary_maya2017.resources.ui import preferences
from modelLibrary_maya2017.resources.ui import catalogue
from modelLibrary_maya2017.resources.ui import model
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def publish(self):
        ...
        if not label:
            ...
            return
        studio_model = studioModel.Model(
            geometry_dag_paths=geometry_dag_paths
        )
    ...
    def builds(self, tag, listwidge, *args):
        ...
        self.model.image_to_button(
            path=studio_model.get_image(publish_path)
        )
        if tag == "build":
            studio_model.create()
