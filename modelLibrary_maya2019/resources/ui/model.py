...
from modelLibrary_maya2019.modules import studioImage
...
class Model(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.verticallayout_model = QtWidgets.QVBoxLayout(
            self.groupbox_model
        )
        self.verticallayout_model.setObjectName(
            "verticallayout_model"
        )
